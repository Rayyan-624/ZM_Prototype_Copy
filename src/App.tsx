...
const TRANS: Record<string, { en: string ur: string }> = {
  ...
  // Orientation voice (Urdu version)
  "orient.search": {
...
function LangProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = (key: string) => TRANS[key]?.[lang] ?? key
  const tc = (name: string) => TRANS[`c.${name}`]?.[lang] ?? name

  return (
    <>
      <style>{ZM_THEME_CSS}</style>
      <LangContext.Provider
        value={{ lang, setLang, t, tc, voiceEnabled, setVoiceEnabled }}
      >
        {children}
      </LangContext.Provider>
    </>
...
const ICON_PATHS: Record<string, string> = {
  ...
  //  By-product icons – Edible Oils (folder name has space)
  "Canola-Seed": `${BYPRODUCTS_PATH}/edible oils/Canola-Seed.png`,
  "Canola-Oil": `${BYPRODUCTS_PATH}/edible oils/Canola-Oil.png`,
  "Canola-Meal": `${BYPRODUCTS_PATH}/edible oils/Canola-Meal.png`,
  "Sunflower-Seed": `${BYPRODUCTS_PATH}/edible oils/Sunflower-Seed.png`,
  "Sunflower-Oil": `${BYPRODUCTS_PATH}/edible oils/Sunflower-Oil.png`,
  "Sunflower-Meal": `${BYPRODUCTS_PATH}/edible oils/Sunflower-Meal.png`,
  ...
  //  By-product icons – Pulses
  "Red-Lentils": `${BYPRODUCTS_PATH}/pulses/Red-Lentils.png`,
  "Red-Lentils-Whole": `${BYPRODUCTS_PATH}/pulses/Red-Lentils-Whole.png`,
  "Gram-Black": `${BYPRODUCTS_PATH}/pulses/Gram-Black.png`,
  "Gram-Pulse": `${BYPRODUCTS_PATH}/pulses/Gram-Pulse.png`,
  "Gram-White": `${BYPRODUCTS_PATH}/pulses/Gram-White.png`,
  "Mung-Whole": `${BYPRODUCTS_PATH}/pulses/Mung-Whole.png`,
  "Mung-Washed": `${BYPRODUCTS_PATH}/pulses/Mung-Washed.png`,
  "Mash-Whole": `${BYPRODUCTS_PATH}/pulses/Mash-Whole.png`,
  "Mash-Washed": `${BYPRODUCTS_PATH}/pulses/Mash-Washed.png`,
  "Mash-Shell": `${BYPRODUCTS_PATH}/pulses/Mash-Shell.png`,
  "Mung-Shell": `${BYPRODUCTS_PATH}/pulses/Mung-Shell.png`,
  "Red-Kidney-Bean": `${BYPRODUCTS_PATH}/pulses/Red-Kidney-Bean.png`,
  "White-Kidney-Bean": `${BYPRODUCTS_PATH}/pulses/White-Kidney-Bean.png`,
  Pigeon: `${BYPRODUCTS_PATH}/pulses/Pigeon.png`,

  //  By-product icons – Spices
  "Red-Chilli": `${BYPRODUCTS_PATH}/spices/Red-Chilli.png`,
  "Red-Chilli-Powder": `${BYPRODUCTS_PATH}/spices/Red-Chilli-Powder.png`,
  "Green-Chilli": `${BYPRODUCTS_PATH}/spices/Green-Chilli.png`,
  "White-Cumin": `${BYPRODUCTS_PATH}/spices/White-Cumin.png`,
  "Black-Cumin": `${BYPRODUCTS_PATH}/spices/Black-Cumin.png`,
  Turmeric: `${BYPRODUCTS_PATH}/spices/Turmeric.png`,
  "Black-Pepper": `${BYPRODUCTS_PATH}/spices/Black-Pepper.png`,
  "Black-Pepper-Powder": `${BYPRODUCTS_PATH}/spices/Black-Pepper-Powder.png`,
  Fennel: `${BYPRODUCTS_PATH}/spices/Fennel.png`,
  Cinnamon: `${BYPRODUCTS_PATH}/spices/Cinnamon.png`,
  Clove: `${BYPRODUCTS_PATH}/spices/Clove.png`,
  "Small-Cardamom": `${BYPRODUCTS_PATH}/spices/Small-Cardamom.png`,
  "Large-Cardamom": `${BYPRODUCTS_PATH}/spices/Large-Cardamom.png`,
  Coriander: `${BYPRODUCTS_PATH}/spices/Coriander.png`,
  "Coriander-Powder": `${BYPRODUCTS_PATH}/spices/Coriander-Powder.png`,
  ...
  Jaifal: `${BYPRODUCTS_PATH}/dates/Jaifal.png`,
  Jamsor: `${BYPRODUCTS_PATH}/dates/Jamsor.png`,
  Kupra: `${BYPRODUCTS_PATH}/dates/Kupra.png`,

  //  By-product icons – Fruits (all fruit by-products are in fruits/ folder)
  "Mango-Sindhri": `${BYPRODUCTS_PATH}/fruits/Mango-Sindhri.png`,
  "Mango-White-Chaunsa": `${BYPRODUCTS_PATH}/fruits/Mango-White-Chaunsa.png`,
  "Mango-Black-Chaunsa": `${BYPRODUCTS_PATH}/fruits/Mango-Black-Chaunsa.png`,
  "Mango-Anwar-Ratul": `${BYPRODUCTS_PATH}/fruits/Mango-Anwar-Ratul.png`,
  "Mango-Fajri": `${BYPRODUCTS_PATH}/fruits/Mango-Fajri.png`,
  Oranges: `${BYPRODUCTS_PATH}/fruits/Oranges.png`,
  Mausambi: `${BYPRODUCTS_PATH}/fruits/Mausambi.png`,
  Grapefruit: `${BYPRODUCTS_PATH}/fruits/Grapefruit.png`,
  "Sweet-Lime": `${BYPRODUCTS_PATH}/fruits/Sweet-Lime.png`,
  Fruiter: `${BYPRODUCTS_PATH}/fruits/Fruiter.png`,
  Watermelon: `${BYPRODUCTS_PATH}/fruits/Watermelon.png`,
  Apple: `${BYPRODUCTS_PATH}/fruits/Apple.png`,
  Apricot: `${BYPRODUCTS_PATH}/fruits/Apricot.png`,
  Banana: `${BYPRODUCTS_PATH}/fruits/Banana.png`,
  Cherry: `${BYPRODUCTS_PATH}/fruits/Cherry.png`,
  Falsa: `${BYPRODUCTS_PATH}/fruits/Falsa.png`,
  Melon: `${BYPRODUCTS_PATH}/fruits/Melon.png`,
  Papaya: `${BYPRODUCTS_PATH}/fruits/Papaya.png`,
  Peach: `${BYPRODUCTS_PATH}/fruits/Peach.png`,
  Pomegranate: `${BYPRODUCTS_PATH}/fruits/Pomegranate.png`,

  //  By-product icons – Vegetables (garlic & potato now inside vegetables/)
  ...
  Spinach: `${BYPRODUCTS_PATH}/vegetables/Spinach.png`,
  // Potato variants (inside vegetables/ folder)
  ...
  //  By-product icons – Fertilizers (note: folder spelled "ferilizers" in file system)
  Urea: `${BYPRODUCTS_PATH}/ferilizers/Urea.png`,
  "Zabardast-Urea": `${BYPRODUCTS_PATH}/ferilizers/Zabardast-Urea.png`,
  DAP: `${BYPRODUCTS_PATH}/ferilizers/DAP.png`,
  NP: `${BYPRODUCTS_PATH}/ferilizers/NP.png`,
  NPK: `${BYPRODUCTS_PATH}/ferilizers/NPK.png`,
  SSP: `${BYPRODUCTS_PATH}/ferilizers/SSP.png`,
  MOP: `${BYPRODUCTS_PATH}/ferilizers/MOP.png`,
  TSP: `${BYPRODUCTS_PATH}/ferilizers/TSP.png`,
  CAN: `${BYPRODUCTS_PATH}/ferilizers/CAN.png`,
  "SOP-G": `${BYPRODUCTS_PATH}/ferilizers/SOP-G.png`,
  "Ammonium-Nitrate": `${BYPRODUCTS_PATH}/ferilizers/Ammonium-Nitrate.png`,
  "Ammonium-Sulphate": `${BYPRODUCTS_PATH}/ferilizers/Ammonium-Sulphate.png`,
  "Pak-Arab-Guara": `${BYPRODUCTS_PATH}/ferilizers/Pak-Arab-Guara.png`,
  Enrich: `${BYPRODUCTS_PATH}/ferilizers/Enrich.png`,

  //  By-product icons – Weedicides/Pesticides
  "Chlorfenapyr-36SC": `${BYPRODUCTS_PATH}/weedicides/Chlorfenapyr-36SC.png`,
  "Clothianidin-20EC": `${BYPRODUCTS_PATH}/weedicides/Clothianidin-20EC.png`,
  "Mesotrione-Atrazine-50WP": `${BYPRODUCTS_PATH}/weedicides/Mesotrione-Atrazine-50WP.png`,
  "Mesotrione-Atrazine-55WP": `${BYPRODUCTS_PATH}/weedicides/Mesotrione-Atrazine-55WP.png`,
  "S-metolachlor": `${BYPRODUCTS_PATH}/weedicides/S-metolachlor.png`,
  cigarete: `${BYPRODUCTS_PATH}/weedicides/S-metolachlor.png`,
  ...
  //  By-product icons – Livestock
  alfalfa2: `${BYPRODUCTS_PATH}/livestock/alfalfa.png`,
  buffalo2: `${BYPRODUCTS_PATH}/livestock/buffalo.png`,
  camel2: `${BYPRODUCTS_PATH}/livestock/camel.png`,
  cattle2: `${BYPRODUCTS_PATH}/livestock/cattle.png`,
  chicken2: `${BYPRODUCTS_PATH}/livestock/chicken.png`,
  goat2: `${BYPRODUCTS_PATH}/livestock/goat.png`,
  milk2: `${BYPRODUCTS_PATH}/livestock/milk.png`,
  "rhode-grass2": `${BYPRODUCTS_PATH}/livestock/rhode-grass.png`,
  slaughter2: `${BYPRODUCTS_PATH}/livestock/slaughter.png`,
}
...
function SpriteIcon({
  ...
  const src = ICON_PATHS[spriteKey]
  if (!src)
...
function CommodityIcon({
  ...
  const key = getSpriteKey(name, vertical)
  if (key)
    return (
      <SpriteIcon
        spriteKey={key}
    ...
    <div className="relative flex-shrink-0" style={style}>
      <div
        ...
        style={{
          ...
          alignItems: "center",
          gap: 8,
          paddingLeft: scrolled ? 52 : 14,
          paddingRight: atEnd ? 14 : 52,
          paddingTop: 7,
          paddingBottom: 10,
      ...
      {scrolled && (
        <button
          onClick={scrollLeft}
          className="tap-target absolute left-0 top-0 bottom-0 flex items-center justify-start pl-1"
          style={{
            width: 52,
            background: `linear-gradient(to left, transparent, ${bg} 55%)`,
            zIndex: 2,
          }}
        >
          <span
      ...
      {!atEnd && (
        <button
          onClick={scrollRight}
          className="tap-target absolute right-0 top-0 bottom-0 flex items-center justify-end pr-1"
          style={{
            width: 52,
            background: `linear-gradient(to right, transparent, ${bg} 55%)`,
            zIndex: 2,
          }}
        >
          <span
...
function TrendBadge({
  ...
  if (trend === "up")
    return (
      <span
        style={{ background: "#E4F2EC", color: "#147A3F" }}
        className={
          compact
            ? "text-[10px] font-bold px-1 py-0 rounded-full flex-shrink-0"
          ...
          {bps.map((bp) => (
            <button
              ...
              style={{
                ...
                border: `${
                  isBP(bp) ? "2px solid #087F63" : "1px solid #D5E2DD"
                }`,
              }}
            >
              <CommodityIcon
    ...
    >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <input
              ...
              placeholder="Search commodity or byproduct…"
              className="flex-1 text-sm bg-transparent outline-none font-medium"
              style={{ color: "#183B34", fontFamily: "'Inter', sans-serif" }}
            />
            {q ? (
              <button
                onClick={() => setQ("")}
                className="tap-target text-sm flex-shrink-0"
                style={{ color: "#52635F" }}
              ></button>
            ) : (
              <span
      ...
      {results.length === 0 && q.length < 1 && (
        <div className="flex-1 flex flex-col items-center justify-center gap-4 px-8">
          ...
          <p className="text-center font-semibold" style={{ color: "#52635F" }}>
            Search for any commodity or byproduct — wheat, basmati, bran,
            tomato…
          </p>
        </div>
      )}
...
function CommoditySelectScreen({
  ...
  const { voiceEnabled, t: tl, tc } = useLang()
  ...
  const title = openDiv ? openDiv.name : "Product"
  const breadcrumb = openDiv ? "Select products to watch" : null
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {breadcrumb ?? "Tap products you want to follow"}
            </p>
          </div>
          {selected.length > 0 && (
            <span
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-4 pt-5 pb-4">
        {/* Divisions grid — product-type toggles in place, vertical-type drills in */}
        {!openDiv && (
          <div
            style={{
              display: "grid",
          ...
          >
            {[...PRODUCT_DIVISIONS]
              ...
              .map((div) => {
                ...
                const btnSize = subscribed ? 96 : 68
                const iconSize = subscribed ? 58 : 38
                return (
                  <div key={div.name} className="flex flex-col items-center">
                    <button
                      ...
                      style={{
                        ...
                        filter: subscribed
                          ? undefined
                          : "blur(1.5px) grayscale(0.5)",
                        opacity: subscribed ? 1 : 0.55,
                        cursor: subscribed ? "pointer" : "default",
                      }}
                    >
                      <CommodityIcon name={div.name} size={iconSize} />
                      {sel && subscribed && (
                        <div
...
function ByProductCombinedScreen({
  ...
  const { voiceEnabled, lang, tc: tcL } = useLang()
  ...
  const handleCardTap = (r: RichRow, bp: string, navigateFn: () => void) => {
    if (voiceEnabled) {
      ...
      const text =
        lang === "ur"
          ? r.min > 0
            ? `${commName} ${bpName}۔ قیمت ${r.min.toLocaleString()} سے ${r.max.toLocaleString()} روپے۔ ${r.mandiName} میں آمد ${r.arrival}۔`
            : `${commName} ${bpName}۔ ${r.mandiName} میں آج کا ڈیٹا موجود نہیں۔`
          : r.min > 0
  ...
  const handleMandiChipTap = (_mandiName: string) => {
    /* mandi chips in deep view */
  }
      ...
      >
        ...
        <div className="px-4 pt-10 pb-2 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1
              ...
              style={{ color: "#183B34" }}
            >
              {activeProduct?.commodity || "Products"}
            </h1>
            {/* <p className="text-xs" style={{ color: "#52635F" }}>
              {byproducts.length} By Products · Scroll for history
            </p> */}
          </div>
        ...
        <ScrollRow bg="#fff" style={{ borderTop: "1px solid #E8EFEC" }}>
          ...
          <button
            onClick={() => {
              ...
              if (voiceEnabled)
                speakText("All products selected. All prices are shown.")
            }}
            ...
            return (
              <button
                ...
                onClick={() => {
                  setActive(i)
                  if (voiceEnabled)
                    speakText(`All ${p.commodity} byproduct prices are shown.`)
                }}
        ...
        <ScrollRow bg="#fff" style={{ borderTop: "1px solid #E8EFEC" }}>
          ...
          <button
            onClick={() => {
              setSelectedBP(null)
              const prodName = activeProduct?.commodity || "all products"
              if (voiceEnabled)
                speakText(`All byproducts of ${prodName} shown.`)
            }}
            className="tap-target flex-shrink-0 rounded-full font-semibold text-xs px-3 py-2"
            style={{
        ...
        <ScrollRow bg="#fff" style={{ borderTop: "1px solid #E8EFEC" }}>
          ...
          <button
            onClick={() => {
              ...
              if (voiceEnabled) speakText("All price types are shown.")
            }}
            className="tap-target flex-shrink-0 rounded-full font-semibold text-xs px-3 py-2"
            style={{
              background:
          ...
          {ALL_RATE_TYPES.map((rt) => {
            ...
            return (
              <button
                key={rt}
                onClick={() => {
                  handlePriceChipTap(rt)
                  if (voiceEnabled)
                    speakText(
                      on
                        ? "All price types are shown."
                        : `All ${rt} rates are shown.`,
                    )
                }}
                className="tap-target flex-shrink-0 rounded-full font-semibold text-xs px-3 py-2"
                style={{
        ...
        {selectedRateTypes.length > 0 && (
          ...
          >
            <button
              ...
              className="tap-target flex items-center gap-1 rounded-full font-semibold text-xs px-3 py-1.5"
              style={{
                background: "#F9E1DE",
                color: "#A83B37",
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <p className="font-bold text-lg">Select Locations</p>
            {draft.length > 0 && (
              <button
                onClick={() => setDraft([])}
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          >
            ...
            >
              <span style={{ fontSize: 20 }}></span>
              <div className="flex-1 text-left">
                <p className="font-bold text-sm" style={{ color: "#9A6817" }}>
                  My Country
                </p>
                <p className="text-xs" style={{ color: "#52635F" }}>
                  Pakistan
            ...
            >
              <span style={{ fontSize: 20 }}></span>
              <div className="flex-1 text-left">
                <p className="font-bold text-sm" style={{ color: "#075E4F" }}>
                  My District
                </p>
                <p className="text-xs" style={{ color: "#52635F" }}>
                  {MY_DISTRICT}
            ...
            >
              {(["province", "district", "mandi"] as const).map((t) => (
                <button
                  key={t}
                  onClick={() => setTab(t)}
                  className="tap-target flex-1 rounded-xl font-bold text-[11px]"
                  style={{
                    height: 34,
            ...
            {(tab === "district" || tab === "mandi") && (
              <div className="flex gap-1 mt-2 overflow-x-auto pb-1">
                <button
                  ...
                  className="tap-target flex-shrink-0 rounded-full font-semibold text-xs px-3 py-1"
                  style={{
        ...
        >
          ...
          >
            {draft.length > 0
              ? `Apply ${draft.length} Location${draft.length > 1 ? "s" : ""}`
              : "Show All"}
          </button>
        </div>
      </div>
...
function RateCard({
  ...
  return (
    <button
      onClick={onClick}
      className="tap-target w-full h-full rounded-2xl overflow-hidden text-left"
      style={{
        background: "#F4FAF7",
        border: "1px solid #D5E2DD",
    ...
    >
      <div className="flex h-full">
        ...
        >
          <CommodityIcon name={r.byproduct || vKey} vertical={vKey} size={46} />
          <span
            className="text-[8px] font-bold mt-1 text-center px-1 leading-tight"
            style={{ color: bg }}
          >
            {vKey}
          </span>
        ...
        <div className="flex-1 p-3 flex flex-col gap-2">
          {/* Row 1: trend badge (left) + name */}
          <div className="flex items-center gap-2">
            <TrendBadge trend={r.trend} pct={r.trendPct} />
            <p
              className="font-extrabold text-sm leading-tight truncate flex-1 min-w-0"
              style={{ color: "#183B34" }}
            >
              {r.byproduct || r.commodity}
            </p>
          </div>
          {/* Row 2: arrival */}
          <p className="text-xs" style={{ color: "#52635F" }}>
            <span className="font-semibold">Arrival:</span> {r.arrival}
          </p>
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="text-right">
              ...
              <p className="font-extrabold text-lg" style={{ color: bg }}>
                {fmt(r.max)}
              </p>
            </div>
          </div>
...
function CommodityRatesScreen({
  ...
  const [msgModal, setMsgModal] = useState<FeedMsg | null>(null)
  const [activeTypes, setActiveTypes] = useState<string[]>([...ALL_RATE_TYPES])
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-extrabold text-xl truncate leading-tight">
                {title}
              </h1>
            </div>
          </div>
        ...
        <div className="px-4 pb-2 flex gap-1.5">
          {([
            ["overview", "Overview"],
            ["trends", "Trends"],
          ] as ["overview" | "trends", string][]).map(([t, label]) => (
            <button
              key={t}
              onClick={() => setTab(t)}
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-6 flex flex-col gap-4">
        {rows.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 opacity-50">
            <span style={{ fontSize: 48 }}></span>
            <p className="font-semibold mt-2">No data available.</p>
          </div>
        )}
          ...
          <>
            ...
            <div className="flex items-center gap-2">
              <p
                ...
                style={{ color: "#52635F", letterSpacing: "0.05em" }}
              >
                {statDateFilter
                  ? (() => {
                      const mn = [
                      ...
                      return `${statDateFilter.getDate()} ${mn[statDateFilter.getMonth()]} Overview`
                    })()
                  : "Today's Overview"}
              </p>
              {/* Date flipper button */}
              {(() => {
                ...
                const sdMonthName = statDateCalMonth.toLocaleDateString(
                  "en-US",
                            ...
                            {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map(
                              (d) => (
                                <div
                                  ...
                                  style={{ color: "#80918B", paddingBottom: 2 }}
                                >
                                  {d}
                                </div>
                              ),
            ...
            >
              ...
              >
                <p
                  ...
                  style={{ color: "#075E4F", opacity: 0.75 }}
                >
                  MAX
                </p>
                <p
                  className="font-extrabold mt-0.5"
                  style={{ fontSize: 16, color: "#075E4F", lineHeight: 1.2 }}
                >
                  {fmt(statMax)}
                </p>
              </div>
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: "#9A6817", opacity: 0.75 }}
                >
                  MIN
                </p>
                <p
                  className="font-extrabold mt-0.5"
                  style={{ fontSize: 16, color: "#9A6817", lineHeight: 1.2 }}
                >
                  {fmt(statMin)}
                </p>
              </div>
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: "#147D72", opacity: 0.75 }}
                >
                  ARRIVAL
                </p>
                <p
                  className="font-extrabold mt-0.5"
                  style={{ fontSize: 13, color: "#147D72", lineHeight: 1.2 }}
                >
                  {statArrival > 0 ? statArrival.toLocaleString() : "—"}
                </p>
              </div>
              {/* RATE TYPE */}
              <button
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrRateType ? "#075E4F" : "#80918B" }}
                >
                  RATE TYPE
                </p>
                <p
                ...
                >
                  {attrRateType ? attrRateType.replace(" Rate", "") : "—"}
                </p>
              </button>
              {/* VARIETY */}
              <button
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrVariety ? "#147A3F" : "#80918B" }}
                >
                  VARIETY
                </p>
                <p
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrNewOld ? "#92400E" : "#80918B" }}
                >
                  NEW/OLD
                </p>
                <p
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrColor ? "#075E4F" : "#80918B" }}
                >
                  COLOR
                </p>
                <p
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrSpec ? "#92400E" : "#80918B" }}
                >
                  SPEC
                </p>
                <p
              ...
              >
                <p
                  className="text-[9px] font-bold tracking-wide"
                  style={{ color: attrCondition ? "#075E4F" : "#80918B" }}
                >
                  CONDITION
                </p>
                <p
            ...
            {(() => {
              ...
              const tcMonthName = tableDateCalMonth.toLocaleDateString(
                "en-US",
                { month: "long", year: "numeric" },
              )
              ...
              return (
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div>
                        ...
                        <p
                          ...
                          style={{ color: "#52635F" }}
                        >
                          {tableRows.length} mandi
                          {tableRows.length !== 1 ? "s" : ""} · tap row to view
                          details
                        </p>
                      </div>
                      {/* Date picker button */}
                  ...
                  >
                    ...
                    <span
                      className="text-[9px] font-extrabold uppercase tracking-wide text-right"
                      style={{ color: "#80918B" }}
                    >
                      Min
                    </span>
                    ...
                    <span
                      className="text-[9px] font-extrabold uppercase tracking-wide text-center"
                      style={{ color: "#80918B" }}
                    >
                      Type
                    </span>
                      ...
                      return (
                        ...
                        >
                          <span
                            ...
                            style={{ color: "#183B34" }}
                          >
                            {r.mandiName.replace(" Mandi", "")}
                          </span>
                          <span
                            className="text-xs font-bold"
                            style={{ color: "#52635F", textAlign: "right" }}
                          >
                            {fmt(Math.round(r.min * effMult))}
                          </span>
                          <span
                            className="text-xs font-extrabold"
                            style={{ color: "#087F63", textAlign: "right" }}
                          >
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="px-5 pt-4 pb-3 border-b border-[#DCE8E3] flex-shrink-0">
                        <div className="zm-drag-handle" />
                        <p className="font-bold text-lg">{labels[attrSheet]}</p>
                      </div>
                      <div
                        ...
                        {opts[attrSheet].map((opt) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {!available && (
                                <span
                                  style={{ fontSize: 10, color: "#80918B" }}
                                >
                                  Not in mandi
                                </span>
                              )}
            ...
            {dateTableOpen &&
              (() => {
                ...
                const monthName = calM.toLocaleDateString("en-US", {
                  month: "long",
                  year: "numeric",
                })
                ...
                const selDateStr = selD.toLocaleDateString("en-GB", {
                  weekday: "long",
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                ...
                const colOpts: Record<string, string[]> = {
                  Quality: qualities,
                  "Price Type": allPriceTypes.map((t) =>
                    t.replace(" Rate", ""),
                  ),
                  Specification: specs,
                    ...
                    >
                                    ...
                                    {dtOpenCol === col && (
                                      ...
                                      >
                                        <button
                                          ...
                                          className="tap-target w-full text-left px-3 py-2 text-xs font-semibold"
                                          style={{
                                            color:
                                              !activeVal &&
                                              !(
                      ...
                      >
                        ...
                        <button
                          ...
                          className="tap-target text-xs font-bold"
                          style={{ color: "#075E4F" }}
                        >
                          Close
                        </button>
        ...
        {tab === "trends" && rows.length > 0 && (
          <>
            ...
            <div className="flex gap-2">
              {(["week", "month", "quarter"] as const).map((t) => (
                <button
                  ...
                  style={{
                    height: 38,
                    background: range === t ? "#087F63" : "#fff",
                    color: range === t ? "#fff" : "#183B34",
                    border: range === t ? "none" : "1px solid #D5E2DD",
                  }}
                >
                  {t}
                </button>
                      ...
                      >
                        <span
                          ...
                          style={{
                            width: 7,
                            height: 7,
                            background: on ? RATE_COLORS[t] : "#C7D6D0",
                          }}
                        />
                        {on ? " " : ""}
                        {t.replace(" Rate", "")}
                ...
                {arrivalHoverIdx !== null && (
                  ...
                  >
                    <span
                      ...
                      style={{ color: "#9A6817" }}
                    >
                      {xLabels[arrivalHoverIdx] || `Day ${arrivalHoverIdx + 1}`}
                    </span>
                    <span
            ...
            >
              <div className="flex-1">
                <p className="font-bold text-sm">Need older data?</p>
                <p className="text-xs" style={{ color: "#52635F" }}>
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{ background: "#C7D6D0" }}
                  />
                  <p className="font-bold text-lg">Select Mandi</p>
                  ...
                  {availMandis.map((mandiName) => {
                    ...
                    return (
                      ...
                      >
                        <span
                          className="flex-1 text-left font-semibold text-sm"
                          style={{ color: isActive ? "#075E4F" : "#183B34" }}
                        >
                          {mandiName}
                        </span>
                        {isActive && (
              ...
              {[
                {
                  id: "today" as const,
                  label: "Today",
                  dateLabel: "17 Aug 2026 · Tuesday",
                  sub: "Latest available rates",
                  icon: "",
                },
                {
                  id: "date" as const,
                  label: "Yesterday",
                  dateLabel: "16 Aug 2026 · Monday",
                  sub: "Previous day rates",
                  icon: "",
                },
                {
                  id: "range" as const,
                  ...
                  sub: "Compare across multiple days",
                  icon: "",
                },
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p
                      className="font-bold text-sm"
                      style={{ color: dateMode === id ? "#075E4F" : "#183B34" }}
                    >
                      {label}
                    </p>
                    <p
                      className="text-[11px] font-semibold"
                      style={{ color: dateMode === id ? "#087F63" : "#2F4A43" }}
                    >
                      {dateLabel}
                    </p>
                    <p
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="font-extrabold text-xl">Mandis</h1>
          </div>
        </div>
        <div className="flex gap-2">
  ...
  return (
    ...
    >
      <header
        ...
        style={{ background: "#F4FAF7", borderBottom: "1px solid #D5E2DD" }}
      >
        <h1 className="font-extrabold text-xl mb-3 px-4"> Analytics</h1>
  ...
  return (
    ...
    >
      <header
        ...
        style={{ background: "#F4FAF7", borderBottom: "1px solid #D5E2DD" }}
      >
        <h1 className="font-extrabold text-xl mb-3">News &amp; Videos</h1>
        <div className="flex gap-2">
...
function HomeScreen({
  ...
  const getFavoriteImage = (bp: string) => {
    const spriteKey = COMMODITY_SPRITE_KEY[bp]
    return spriteKey ? ICON_PATHS[spriteKey] : null
  }
...
<div
  ...
  style={{
    height: 230,   // ← taller to give search bar room to overlap
    zIndex: 20,
  }}
>
  {/* Farm image — extends to full height so search overlaps it */}
  <div
    style={{
      position: "absolute",
      top: 0,
      left: 0,
      right: 0,
      height: 210,          // ← covers more, search sits on top

      backgroundImage: `
        linear-gradient(
          180deg,
          rgba(2,57,42,0.64) 0%,
          rgba(3,84,61,0.48) 50%,
          rgba(3,84,61,0.72) 100%
        ),
        url("src/icons/farm.png")
      `,
  ...
  >
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="tap-target rounded-full px-3 py-1"
          style={{
        ...
        <button
          ...
          style={{
            background: homeVoiceEnabled
              ? "rgba(47,191,113,0.32)"
        ...
        >
          ...
          <span>
            {lang === "ur"
              ? homeVoiceEnabled ? "آواز آن" : "آواز آف"
              : homeVoiceEnabled ? "Voice On" : "Voice Off"}
          </span>
        </button>
      </div>
    ...
    {/* User information — pushed toward the bottom of the image */}
    <div
      className="mt-auto"
      style={{
        paddingBottom: 60,   // ← less bottom padding so name sits higher above search
      }}
    >
      <h1
        style={{
      ...
      >
        ...
        <span>{t("home.pakpattan")}</span>
      </div>
    </div>
  </div>

  {/* =================================================
      FLOATING SEARCH BAR — overlaps the farm image
      ================================================= */}
  ...
  <button
    ...
    className="tap-target flex items-center gap-3 text-left"
    style={{
      position: "absolute",
      left: 17,
      right: 17,
      bottom: 0,           // ← sits at the very bottom of the 230px container,
                           //   which is 20px below the 210px image → overlaps
      ...
      borderRadius: 28,
      background: "#F8FCFA",
      border: "1px solid rgba(8,127,99,0.12)",
      boxShadow: "0 5px 18px rgba(15,70,50,0.16)",
      zIndex: 30,
    }}
  >
    {/* Search icon */}
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      background:
                        "linear-gradient(145deg,#F9FCFA,#E4F2EC)",
...
const ORIENT_CARDS = [
  {
    ...
    // floats just below the search bar (bar ends ~y214 in container coords)
  ...
  },
  {
    ...
    // anchored inside the left Product button zone (y 230-398), lower-centre
  ...
  },
  {
    ...
    // anchored inside top-right button (y 230-308)
  ...
  },
  {
    ...
    // anchored inside bottom-right button (y 320-398)
  ...
  },
  {
    ...
    // just below the Your Picks section header (~y 414)
...
function VoiceOrientationOverlay({ onClose }: { onClose: () => void }) {
  ...
  const handleCardTap = (key: string, label: string, desc: string) => {
    const next = activeCard === key ? null : key
    setActiveCard(next)
    if (next) speakText(`${label}. ${desc}`)
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ top: 48, pointerEvents: "none" }}
      >
        <span
      ...
      {ORIENT_CARDS.map((card) => {
        ...
        return (
          <button
            key={card.key}
            onClick={() => handleCardTap(card.key, card.label, card.desc)}
            className="absolute flex items-center gap-2 rounded-xl text-left"
            style={{
              ...card.pos,
              pointerEvents: "auto",
              background: isActive ? "#087F63" : "rgba(255,255,255,0.95)",
              borderLeft: `3px solid ${isActive ? "#2FAE68" : "#087F63"}`,
              boxShadow: isActive
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <p
                ...
                style={{ color: isActive ? "#fff" : "#16352F" }}
              >
                {card.label}
              </p>
              <p
                ...
                style={{
                  color: isActive ? "rgba(255,255,255,0.82)" : "#52635F",
                }}
              >
                {card.desc}
              </p>
...
function VoiceQueryOverlay({
  ...
  useEffect(() => {
    ...
    timerRef.current = setTimeout(() => {
      setTranscript("Wheat in Pakpattan Mandi, Mill Rate")
      setPhase("processing")
      timerRef.current = setTimeout(() => {
        setPhase("speaking")
        timerRef.current = setTimeout(() => {
    ...
    >
      ...
      {phase === "listening" && (
        <div className="flex flex-col items-center gap-5 px-8">
          ...
          <p className="font-bold text-white text-lg">Listening…</p>
          <p
            className="text-sm text-center"
            style={{ color: "rgba(255,255,255,0.55)", maxWidth: 240 }}
          >
      ...
      {phase === "processing" && (
        <div className="flex flex-col items-center gap-5 px-8">
          ...
          <p className="font-bold text-white text-lg">Understanding…</p>
          {transcript && (
            <div
...
function BottomNav({
  ...
  return (
    <nav
      className="flex-shrink-0 flex items-center justify-around px-2 pt-2 relative z-50"
      style={{
        height: 68,
        background: "#F4FAF7",
        borderTop: "1px solid #D5E2DD",
    ...
    >
      {regularTabs.map((t) => (
        <button
          key={t.id}
          onClick={() => onNav(t.id)}
          className="tap-target flex flex-col items-center gap-0.5 flex-1"
          style={{ color: active === t.id ? "#087F63" : "#52635F" }}
        >
          {NAV_ICONS[t.id]?.(active === t.id)}
      ...
      <button
        ...
        className="tap-target flex flex-col items-center gap-0.5 flex-1 select-none"
      ...
      >
        ...
        <span
          className="text-[10px] font-bold"
          style={{ color: voiceActive ? "#C94A43" : "#52635F" }}
        >
          {t("nav.voice")}
        </span>
      </button>
...
function AppInner() {
  ...
  return (
    <div
      ...
      style={{ background: "#C7D6D0", height: "100dvh" }}
    >
      <div
