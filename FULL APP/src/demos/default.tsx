...
const tabItems: TabItem[] = [
  {
    color: "#ff8c00",
    icon: (
      <svg className="icon" viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    icon: (
      <svg className="icon" viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2">
        <path d="M5.1,3.9h13.9c0.6,0,1.2,0.5,1.2,1.2v13.9c0,0.6-0.5,1.2-1.2,1.2H5.1c-0.6-1.2-0.5-1.2-1.2V5.1 C3.9,4.4,4.4,3.9,5.1,3.9z" />
...
const AnimatedTabBarDemo = () => {
  ...
  return (
    <div className="demo-container w-full min-h-[140px] flex items-end justify-center p-4 rounded-2xl transition-colors duration-500" style={{ backgroundColor: bgColor }}>
