...
const PRODUCTS = [
  { id: "wheat", label: "Wheat", price: 500 },
  { id: "rice", label: "Rice", price: 600 },
  { id: "cotton", label: "Cotton", price: 700 },
  { id: "maize", label: "Maize", price: 400 },
  { id: "sugar", label: "Sugar", price: 500 },
  { id: "pulses", label: "Pulses", price: 450 },
  { id: "mustard", label: "Mustard", price: 400 },
  { id: "sesame", label: "Sesame", price: 350 },
  { id: "millet", label: "Millet", price: 300 },
  { id: "paddy", label: "Paddy", price: 400 },
  { id: "dates", label: "Dates", price: 600 },
  { id: "spices", label: "Spices", price: 800 },
  { id: "dryfruit", label: "Dry Fruit", price: 700 },
  { id: "livemarket", label: "Live Market", price: 1000 },
  { id: "fruits", label: "Fruits", price: 1500 },
  { id: "vegetables", label: "Vegetables", price: 1200 },
  { id: "livestock", label: "Livestock", price: 2000 },
  { id: "fertilizer", label: "Fertilizer", price: 1800 },
  { id: "edibleoil", label: "Edible Oil", price: 1500 },
  { id: "kiryana", label: "Kiryana", price: 1000 },
  { id: "herbs", label: "Herbs", price: 400 },
]
          ...
          {filtered.map((p) => (
            ...
            >
              ...
              {selected.includes(p.id) && (
                <div className="item-check" style={{ top: 0, right: "10%" }}>
                  ✓
                </div>
              )}
              <span
...
function PaymentScreen({
  ...
  const paymentMethods = [
    { id: "jazzcash", label: "JazzCash", color: "#E83D2B", icon: "💳" },
    { id: "easypaisa", label: "EasyPaisa", color: "#4CAF50", icon: "📲" },
    { id: "bank", label: "Bank Transfer", color: "#1565C0", icon: "🏦" },
  ] as const
...
export default function App() {
  ...
  console.log("App.tsx: rendering App component, screen =", screen);
  ...
  return (
    <div className="phone-shell">
      ...
      {screen === "loading" && <LoadingScreen onDone={() => go("dashboard")} />}
